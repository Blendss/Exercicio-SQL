...
create table filial (
fk_nome varchar(40) primary key,
cod_filial int(3),
cnpj varchar(20),
endereço VARCHAR(50),
telefone varchar(14),
cod_empresa int(7),
FOREIGN KEY (fk_nome) REFERENCES empregados(nome)
);
...
insert into filial (fk_nome, cod_filial, cnpj, endereço, telefone, cod_empresa) values ("Clementina Borges", "088767", "72.662.768/0001-31", "Rua Doutor Alfredo de Carvalho Pinto", "(82) 3752-0280", "8799789");
insert into filial (fk_nome, cod_filial, cnpj, endereço, telefone, cod_empresa) values ("Jorge Antônio", "900923", "38.352.507/0001-87", "Avenida Capitão Joaquim Rabelo Andrade", "(93) 2358-6396", "8817948");
insert into filial (fk_nome, cod_filial, cnpj, endereço, telefone, cod_empresa) values ("Jorge Adalberto", "565378", "78.217.541/0001-63", "Rua Doutor Benedito Alexandre Trindade Filho", "(68) 2338-5107", "0915764");
insert into filial (fk_nome, cod_filial, cnpj, endereço, telefone, cod_empresa) values ("Carlos Alberto de Nobrega", "101892", "37.263.386/0001-34", "Rua Francisco Fusari", "(79) 2322-3527", "7090459");
insert into filial (fk_nome, cod_filial, cnpj, endereço, telefone, cod_empresa) values ("Paulo Muzy", "374649", "53.978.658/0001-39", "Praça Antônio Prado", "(79) 3495-1622", "3178522");
